function [W, accepted, logacceptprob, w_mode] = draw_W_given_QY(Q, Y, W, kappa, options)
...
logcondpW = -nlogcondpw(W(:), Y, Q);
logcondpW_prime = -nlogcondpw(w_prime, Y, Q);
